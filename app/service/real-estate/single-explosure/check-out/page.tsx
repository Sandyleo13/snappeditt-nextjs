...
import BeforeAfterPreview from "@/components/shared/BeforeAfterPreview";
      ...
      <div className="grid w-full max-w-7xl gap-8 md:gap-12 md:grid-cols-[1fr_1.2fr] items-start">
        ...
        <div className="relative">
          ...
          <div className="relative z-10 space-y-6">
            ...
            {/* Property preview: before/after slider */}
            <div className="relative">
              <BeforeAfterPreview
                before="/images/real-estate-basic-sky-explosure-before.webp"
                after="/images/real-estate-basic-sky-explosure-after.webp"
