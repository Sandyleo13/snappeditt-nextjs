...
export default function HeroAnimation() {
  ...
  return (
    <div className="relative w-full overflow-hidden" style={{ height: 520 }}>
        ...
        <motion.div {...fy(7, 5)} style={{ width: '68%' }}>
          ...
          >
            ...
            <div className="absolute inset-0">
              <img
                src="/images/Real-Estate-Single_Exposure-S-Raw-2.webp"
                alt="Before Single Exposure"
                className="w-full h-full object-cover"
                style={{ filter: 'brightness(0.68) saturate(0.65)' }}
              />
            </div>
            ...
            <div className="absolute inset-0 overflow-hidden" style={{ left: `${sliderPos}%` }}>
              <img
                src="/images/Real-Estate-Single_Exposure-S-Corrected-2.webp"
                alt="After Single Exposure"
      ...
      {/* Exposure Correction card — top left */}
        ...
        <div style={{ background: 'rgba(255,255,255,0.96)', borderRadius: 16, padding: '12px 14px', boxShadow: '0 12px 36px rgba(15,23,42,0.11)', border: '1px solid rgba(228,228,228,0.9)', backdropFilter: 'blur(12px)', width: 170 }}>
          <div className="flex items-center gap-2 mb-2">
            <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-[#FFF0EE] flex-shrink-0">
              ...
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                <circle cx="6.5" cy="6.5" r="2.4" stroke="#E8352A" strokeWidth="1.1" />
                <line x1="6.5" y1="0.5" x2="6.5" y2="2" stroke="#E8352A" strokeWidth="1.1" strokeLinecap="round" />
                <line x1="6.5" y1="11" x2="6.5" y2="12.5" stroke="#E8352A" strokeWidth="1.1" strokeLinecap="round" />
                <line x1="0.5" y1="6.5" x2="2" y2="6.5" stroke="#E8352A" strokeWidth="1.1" strokeLinecap="round" />
                <line x1="11" y1="6.5" x2="12.5" y2="6.5" stroke="#E8352A" strokeWidth="1.1" strokeLinecap="round" />
                <line x1="2.4" y1="2.4" x2="3.4" y2="3.4" stroke="#E8352A" strokeWidth="1.1" strokeLinecap="round" />
                <line x1="9.6" y1="9.6" x2="10.6" y2="10.6" stroke="#E8352A" strokeWidth="1.1" strokeLinecap="round" />
                <line x1="10.6" y1="2.4" x2="9.6" y2="3.4" stroke="#E8352A" strokeWidth="1.1" strokeLinecap="round" />
                <line x1="3.4" y1="9.6" x2="2.4" y2="10.6" stroke="#E8352A" strokeWidth="1.1" strokeLinecap="round" />
              </svg>
            </div>
            <span style={{ fontSize: 11, fontWeight: 600, color: '#1e293b' }}>Exposure Fix</span>
          </div>
          <div style={{ background: '#fafafa', borderRadius: 9, padding: '6px 8px', border: '1px solid #f0f0f0' }}>
            <svg viewBox="0 0 140 38" style={{ width: '100%', height: 38 }}>
              ...
              <path d="M0 32 C12 26 24 30 40 22 S64 10 84 16 S110 8 128 4 L140 2" stroke="#E8352A" strokeWidth="2" fill="none" strokeLinecap="round" />
              <path d="M0 32 C12 26 24 30 40 22 S64 10 84 16 S110 8 128 4 L140 2 L140 38 L0 38Z" fill="url(#sg2)" />
            </svg>
          </div>
        </div>
      </motion.div>

      {/* White Balance card — bottom right */}
      <motion.div {...fy(10, 5.2, 1)} className="absolute" style={{ right: '2%', bottom: '20%', zIndex: 30 }}>
        <div style={{ background: 'rgba(255,255,255,0.96)', borderRadius: 16, padding: '12px 14px', boxShadow: '0 12px 36px rgba(15,23,42,0.11)', border: '1px solid rgba(228,228,228,0.9)', backdropFilter: 'blur(12px)', width: 158 }}>
          <p style={{ fontSize: 11, fontWeight: 600, color: '#1e293b', marginBottom: 8 }}>White Balance</p>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 5, flex: 1 }}>
              <div style={{ height: 4, borderRadius: 9, background: '#f1f5f9' }}>
                <div style={{ height: 4, width: '72%', borderRadius: 9, background: '#E8352A' }} />
              </div>
              <div style={{ height: 4, borderRadius: 9, background: '#f1f5f9' }}>
                <div style={{ height: 4, width: '48%', borderRadius: 9, background: '#fca5a5' }} />
              </div>
