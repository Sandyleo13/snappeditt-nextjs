...
import { ArrowUpRight, Clock, ShieldCheck, CheckCircle } from 'lucide-react';
import AutoBeforeAfterImage from '../../../components/shared/AutoBeforeAfterImage';

const clippingServices = [
  {
    title: 'Clipping Path',
    href: '/service/clipping-path-extraction/clipping-path',
    description: 'Precise background removal for product, jewelry, and apparel imagery.',
    beforeImage: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=900&q=85&auto=format&fit=crop&sat=-30&brightness=75',
    afterImage: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=900&q=85&auto=format&fit=crop',
  },
  {
    title: 'Extraction',
    href: '/service/clipping-path-extraction/extraction',
    description: 'Clean extraction of complex subjects for compositing and marketing artwork.',
    beforeImage: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=900&q=85&auto=format&fit=crop&sat=-30&brightness=75',
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100 text-slate-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid gap-12 lg:grid-cols-[1.03fr_0.97fr] items-center">
          <div className="space-y-8">
            ...
            <div className="max-w-3xl space-y-6">
              <h1 className="text-5xl font-bold tracking-tight text-slate-950 sm:text-6xl">
                Fast, accurate background removal and image extraction.
              </h1>
              <p className="text-lg leading-8 text-slate-600">
                Clean cutouts, transparent backgrounds, and high-precision subject extraction for every product, jewelry, and creative image workflow.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-4 text-sm font-semibold text-slate-950">Rapid delivery</p>
                <p className="mt-2 text-sm leading-6 text-slate-600">Quick turnaround for urgent product and catalog needs.</p>
              </div>
              <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#FEF3C7] text-[#B45309]">
                  <CheckCircle className="h-6 w-6" />
                </div>
                <p className="mt-4 text-sm font-semibold text-slate-950">Precision cuts</p>
                <p className="mt-2 text-sm leading-6 text-slate-600">Pixel-perfect edges for smooth compositing and reflections.</p>
              </div>
              <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-[#ECFDF5] text-[#15803D]">
                  <ShieldCheck className="h-6 w-6" />
                </div>
                <p className="mt-4 text-sm font-semibold text-slate-950">Trusted workflow</p>
                <p className="mt-2 text-sm leading-6 text-slate-600">Secure editing and reliable quality checks on every image.</p>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-[0_30px_80px_rgba(15,23,42,0.08)]">
              <div className="relative h-[520px] w-full overflow-hidden">
                <AutoBeforeAfterImage
                  beforeImage={clippingServices[0].beforeImage}
                  afterImage={clippingServices[0].afterImage}
                  alt="Clipping path sample preview"
              ...
              <div className="absolute bottom-6 left-6 right-6 rounded-[28px] border border-white/60 bg-white/90 p-6 shadow-xl backdrop-blur-md">
                ...
                <p className="mt-2 text-2xl font-bold text-slate-950">Creative studios and retailers</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-4 text-4xl font-bold text-slate-950 sm:text-5xl">Choose the service that fits your clipping and extraction needs.</h2>
          </div>

          <div className="grid gap-5 xl:grid-cols-2">
            {clippingServices.map((service) => (
              <Link
                key={service.href}
                href={service.href}
