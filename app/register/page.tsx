...
import {
  ...
  ArrowRight, Upload, Clock, Shield,
  Image as ImageIcon, Smile, CheckCircle,
} from "lucide-react";
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (pw !== cpw) { setError("Passwords do not match."); setLoading(false); return; }
    try {
  ...
  return (
    <section className="min-h-screen bg-[#F3F4F6] flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-6xl overflow-hidden rounded-3xl shadow-2xl grid md:grid-cols-[1.15fr_1fr]">
        ...
        {/* ══════════════  LEFT PANEL  ══════════════ */}
        <div className="relative hidden md:flex flex-col bg-gradient-to-br from-[#E8352A] via-[#d42d22] to-[#b71c1c] overflow-hidden p-8 xl:p-10 min-h-[680px]">

          {/* Dot grid */}
          <svg className="absolute inset-0 w-full h-full opacity-[0.10] pointer-events-none">
            <defs>
              <pattern id="rgdots" width="22" height="22" patternUnits="userSpaceOnUse">
          ...
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            ...
            <span className="text-white text-xs font-bold tracking-wide">Free to Join</span>
          </motion.div>
          ...
          <div className="relative z-10 mt-4">
            <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }}
              ...
              Start Editing with<br />SnappEditt
            </motion.h2>
            <motion.p initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 0.5 }}
              ...
              Join thousands of photographers, real estate agents and e-commerce brands using professional photo editing.
            </motion.p>
            ...
            <div className="relative w-full">
              ...
              <div className="relative mx-auto w-[88%] bg-[#1a1a2e] rounded-t-xl overflow-hidden shadow-2xl border-2 border-white/20"
                ...
                <motion.div animate={{ y: [-2, 2, -2] }} transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}
                  ...
                  <div>
                    <p className="text-[8px] font-bold text-gray-800 leading-none">Account Ready!</p>
                    <p className="text-[7px] text-gray-400 mt-0.5">Start editing today</p>
                  </div>
                </motion.div>
              </div>
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }}
            ...
            {[
              ...
              { icon: <Clock     className="w-4 h-4" />, value: "24hr", label: "Fast Delivery" },
              { icon: <Smile     className="w-4 h-4" />, value: "99%",  label: "Client Satisfaction" },
            ].map(s => (
        ...
        {/* ══════════════  RIGHT PANEL — FORM  ══════════════ */}
        <div className="bg-white flex items-center justify-center p-7 sm:p-10">
          <div className="w-full max-w-sm">

            <div className="mb-6">
              <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Create Account</h1>
              <p className="mt-1.5 text-gray-500 text-sm">Start your free journey with Snappeditt</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" name="first_name" required placeholder="John"
                      className="w-full pl-9 pr-3 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#E8352A]/20 focus:border-[#E8352A] transition-all" />
                  </div>
                </div>
                <div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" name="email" required placeholder="you@example.com"
                    className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#E8352A]/20 focus:border-[#E8352A] transition-all" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="tel" name="mobile" required placeholder="+1 234 567 8900"
                    className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#E8352A]/20 focus:border-[#E8352A] transition-all" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type={showPassword ? "text" : "password"} name="password" required placeholder="••••••••"
                    className="w-full pl-10 pr-10 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#E8352A]/20 focus:border-[#E8352A] transition-all" />
              ...
              <label className="flex items-start gap-2.5 cursor-pointer select-none">
                <input type="checkbox" required className="w-4 h-4 mt-0.5 rounded border-gray-300 accent-[#E8352A] flex-shrink-0" />
                <span className="text-xs text-gray-500 leading-relaxed">
                  I agree to the{" "}
                  <a href="/terms" className="text-[#E8352A] font-semibold hover:underline">Terms of Service</a>
                  {" "}and{" "}
                  <a href="/privacy" className="text-[#E8352A] font-semibold hover:underline">Privacy Policy</a>
                </span>
              </label>

              {/* Submit */}
              <button type="submit" disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#E8352A] text-white font-bold text-sm hover:bg-[#C62B20] transition-all shadow-[0_8px_24px_rgba(232,53,42,0.28)] hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100">
            ...
            <p className="mt-5 text-center text-sm text-gray-500">
              ...
              <a href="/login" className="font-bold text-[#E8352A] hover:text-[#C62B20] transition-colors">Sign In</a>
            </p>
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <button key={s.label}
                  className="flex flex-col items-center gap-1.5 py-2.5 rounded-xl border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all text-xs font-semibold text-gray-700">
